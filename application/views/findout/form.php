...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		...
		<?php echo $this->session->flashdata('message');?>
		 ...
		 <form action="<?php echo site_url('findout/save/'.$row['id_como_ubico']); ?>" class='form-horizontal' 
		 parsley-validate='true' novalidate='true' method="post" enctype="multipart/form-data" > 


<div class="col-md-12">
						<fieldset><legend> ¿Cómo nos Ubicó?</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
									  <input type='text' class='form-control' placeholder='' value='<?php echo $row['como_ubico'];?>' name='como_ubico'  required /> <br />
									  <i> <small></small></i>
									 </div> 
								  </div> 					
								  <div class="form-group  " >
 		...
 		<div class="toolbar-line text-center">		
			...
			<a href="<?php echo site_url('findout');?>" class="btn btn-sm btn-warning"><?php echo $this->lang->line('core.sb_cancel'); ?> </a>
 		</div>
