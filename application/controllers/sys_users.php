...
class Sys_users extends SB_Controller 
{

	protected $layout 	= "layouts/main";
	public $module 		= 'sys_users';
	public $per_page	= '10';

	function __construct() {
		parent::__construct();
		
		$this->load->model('sys_usersmodel');
		$this->model = $this->sys_usersmodel;
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('sys_users/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('sys_users/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('sys_users/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
	...
	function save() {
		...
		if( $this->form_validation->run() )
		{
			...
			{
				redirect( 'sys_users/add/'.$ID,301);
			} else {
				redirect( 'sys_users',301);
			}			
