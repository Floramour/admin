...
<div class="page-header">
	...
	<ul class="breadcrumb">
		...
		<li><a href="<?php echo site_url('color') ?>"><?php echo $pageTitle ?></a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		...
		<?php echo $this->session->flashdata('message');?>
		 ...
		 <form action="<?php echo site_url('color/save/'.$row['id_color']); ?>" class='form-horizontal' 
...
<div class="col-md-12">
						<fieldset><legend> Colores</legend>
								  ...
								  <div class="form-group hidethis " style="display:none;">
									...
									<div class="col-md-8">
									  <input type='text' class='form-control' placeholder='' value='<?php echo $row['id_color'];?>' name='id_color'   /> <br />
									  <i> <small></small></i>
									 </div> 
								  </div> 					
								  <div class="form-group  " >
									...
									<div class="col-md-8">
									  <input type='text' class='form-control' placeholder='' value='<?php echo $row['color'];?>' name='color'  required /> <br />
									  <i> <small></small></i>
									 </div> 
								  </div> 					
								  <div class="form-group  " >
 		...
 		<div class="toolbar-line text-center">		
			...
			<a href="<?php echo site_url('color');?>" class="btn btn-sm btn-warning"><?php echo $this->lang->line('core.sb_cancel'); ?> </a>
 		</div>
