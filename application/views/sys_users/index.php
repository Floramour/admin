  ...
  <div class="page-content row">
    ...
    <div class="toolbar-line ">		
		...
		<a href="<?php echo site_url('sys_users/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>o Usuario">
		<i class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('core.btn_new'); ?>o Usuario</a>
		<?php endif;
		...
		<a href="<?php echo site_url('sys_users/download') ?>" class="tips btn btn-xs btn-default" title="<?php echo $this->lang->line('core.btn_download'); ?>">
		<i class="fa fa-download"></i>&nbsp;<?php echo $this->lang->line('core.btn_download'); ?></a>
		<?php endif;
		if($this->session->userdata('gid') ==1) : ?>	
		<a href="<?php echo site_url('sximo/module/config/sys_users') ?>" class="tips btn btn-xs btn-default"  title="<?php echo $this->lang->line('core.btn_config'); ?>">
...
<div class="sbox animated fadeInRight">
	...
	<?php echo $this->session->flashdata('message');?>
	 <form action='<?php echo site_url('sys_users/destroy') ?>' class='form-horizontal' id ='SximoTable' method="post" >
                ...
                <tr>
				 ...
				 <td>
					 <div class="btn-group">		
						...
						<li><a href="<?php echo site_url('sys_users/show/'.$row->id)?>"  class="tips "  title="view"><i class="fa  fa-search"></i> <?php echo $this->lang->line('core.btn_view'); ?> </a></li>
						<?php endif;
						if($access['is_edit'] ==1) : ?>
						<li><a  href="<?php echo site_url('sys_users/add/'.$row->id)?>"  class="tips "  title="edit"> <i class="fa fa-edit"></i>  <?php echo $this->lang->line('core.btn_edit'); ?> </a> </li>
						<?php endif;?>
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#SximoTable').attr('action','<?php echo site_url("sys_users/multisearch");?>');
		$('#SximoTable').submit();
	});
