...
<div class="page-header">
	...
	<ul class="breadcrumb">
		...
		<li><a href="<?php echo site_url('canal') ?>"><?php echo $pageTitle ?></a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		...
		<?php echo $this->session->flashdata('message');?>
		 ...
		 <form action="<?php echo site_url('canal/save/'.$row['id_canal']); ?>" class='form-horizontal' 
...
<div class="col-md-12">
						<fieldset><legend> Canales</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
									  <input type='text' class='form-control' placeholder='' value='<?php echo $row['canal'];?>' name='canal'  required /> <br />
									  <i> <small></small></i>
									 </div> 
								  </div> 					
								  <div class="form-group  " >
					...
					$estado_opt = array( 'Activo' => 'Activo' ,  'Inactivo' => 'Inactivo' , ); ?>
					<select name='estado' rows='5' required  class='select2 '  > 
						<?php 
 		...
 		<div class="toolbar-line text-center">		
			...
			<a href="<?php echo site_url('canal');?>" class="btn btn-sm btn-warning"><?php echo $this->lang->line('core.sb_cancel'); ?> </a>
 		</div>
