  ...
  <div class="page-content row">
    ...
    <div class="toolbar-line ">		
		...
		<a href="<?php echo site_url('products/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>o Producto">
		<i class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('core.btn_new'); ?>o Producto</a>
		<?php endif;
		...
		<a href="<?php echo site_url('products/download') ?>" class="tips btn btn-xs btn-default" title="<?php echo $this->lang->line('core.btn_download'); ?>">
		<i class="fa fa-download"></i>&nbsp;<?php echo $this->lang->line('core.btn_download'); ?></a>
		<?php endif;
		if($this->session->userdata('gid') ==1) : ?>	
		<a href="<?php echo site_url('sximo/module/config/products') ?>" class="tips btn btn-xs btn-default"  title="<?php echo $this->lang->line('core.btn_config'); ?>">
...
<div class="sbox animated fadeInRight">
	...
	<?php echo $this->session->flashdata('message');?>
	 <form action='<?php echo site_url('products/destroy') ?>' class='form-horizontal' id ='SximoTable' method="post" >
        ...
        <tbody>
			...
			<?php foreach ( $rowData as $i => $row ) : ?>
                <tr>
					...
					<td width="50"><input type="checkbox" class="ids" name="id[]" value="<?php echo $row->id_producto ?>" />  </td>
				 ...
				 <td>
					 <div class="btn-group">		
						...
						<li><a href="<?php echo site_url('products/show/'.$row->id_producto)?>"  class="tips "  title="view"><i class="fa  fa-search"></i> <?php echo $this->lang->line('core.btn_view'); ?> </a></li>
						<?php endif;
						if($access['is_edit'] ==1) : ?>
						<li><a  href="<?php echo site_url('products/add/'.$row->id_producto)?>"  class="tips "  title="edit"> <i class="fa fa-edit"></i>  <?php echo $this->lang->line('core.btn_edit'); ?> </a> </li>
						<?php endif;?>
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#SximoTable').attr('action','<?php echo site_url("products/multisearch");?>');
		$('#SximoTable').submit();
	});
