		...
		<div class="sbox animated fadeInRight">
			...
			<div class="sbox-content"> 		
				<div class="table-responsive">
					...
					<tr>
						<td width='30%' class='label-view text-right'>Id Canal</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Numero Orden</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Fecha Orden</td>
						<td><?php echo $row['fecha_orden'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Id Como Ubico</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Guia</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Fecha Cobranza</td>
						<td><?php echo $row['fecha_cobranza'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Observacion Cobranza</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Cli Nombre</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Des Nombre</td>
						<td><?php echo $row['des_nombre'] ;?> </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Des Fecha Entrega</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Pro Valor Total</td>
