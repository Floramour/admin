  ...
  <div class="page-content row">
    ...
    <div class="toolbar-line ">		
		...
		<a href="<?php echo site_url('products_colors/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>">
		...
		<a href="<?php echo site_url('products_colors/download') ?>" class="tips btn btn-xs btn-default" title="<?php echo $this->lang->line('core.btn_download'); ?>">
		<i class="fa fa-download"></i>&nbsp;<?php echo $this->lang->line('core.btn_download'); ?></a>
		<?php endif;
		if($this->session->userdata('gid') ==1) : ?>	
		<a href="<?php echo site_url('sximo/module/config/products_colors') ?>" class="tips btn btn-xs btn-default"  title="<?php echo $this->lang->line('core.btn_config'); ?>">
...
<div class="sbox animated fadeInRight">
	...
	<?php echo $this->session->flashdata('message');?>
	 <form action='<?php echo site_url('products_colors/destroy') ?>' class='form-horizontal' id ='SximoTable' method="post" >
                ...
                <tr>
				 ...
				 <td>
					 <div class="btn-group">		
						...
						<li><a href="<?php echo site_url('products_colors/show/'.$row->id_producto)?>"  class="tips "  title="view"><i class="fa  fa-search"></i> <?php echo $this->lang->line('core.btn_view'); ?> </a></li>
						<?php endif;
						if($access['is_edit'] ==1) : ?>
						<li><a  href="<?php echo site_url('products_colors/add/'.$row->id_producto)?>"  class="tips "  title="edit"> <i class="fa fa-edit"></i>  <?php echo $this->lang->line('core.btn_edit'); ?> </a> </li>
						<?php endif;?>
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#SximoTable').attr('action','<?php echo site_url("products_colors/multisearch");?>');
		$('#SximoTable').submit();
	});
